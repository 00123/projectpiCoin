...
// Copyright (c) 2013-2014 piCoin Developers
...
uint256 hashGenesisBlock("0x50468b8ca66ef5634ae1ebc70a57be291c1db2a52f19ef83b8fc90be00f7890d");
...
const string strMessageMagic = "piCoin Signed Message:\n";
...
{
    int64 nSubsidy = 314159 * COIN;
    nSubsidy >>= (nHeight / 31415);
                                 ...
                                 const CBlockIndex* pindexBlock, bool fBlock, bool fMiner, bool fStrictPayToScriptHash)
{
    ...
    // fMiner is true when called from the internal piCoin miner
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "piCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x50468b8ca66ef5634ae1ebc70a57be291c1db2a52f19ef83b8fc90be00f7890d");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "piCoin";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1393530348; //epochtime
        block.nBits    = 0x1e0ffff0;
        block.nNonce   = 2765959;

        if (fTestNet)
        {
            block.nTime    = 1393530348;
            block.nNonce   = 2765959;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x447be99cf59da4ee1380662ef8ff342db5e61f6fa9f988c8c37c4abed5353a15"));
